...
export default function GradeOneMathPage() {
  return <><GameAuthHeader /><GameNavigationGrid title="Toán lớp 1" description="Chọn bài học" breadcrumbs={[{ label: 'Game', href: '/game' }, { label: 'Lớp 1', href: '/game/lop-1' }, { label: 'Toán' }]} items={getMathLessonItems('lop-1')} /></>
}
