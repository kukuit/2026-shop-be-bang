...
export default function Detail({ entity, id }: { entity: 'partners' | 'crops' | 'ponds'; id: string }) {
  ...
  if (!row) return <div className="demo-empty">Không tìm thấy bản ghi. <Link href={`/chatbot/demo/${entity}`}>Quay lại</Link></div>
