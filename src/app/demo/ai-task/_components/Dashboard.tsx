...
export default function Dashboard() {
  ...
  return <>
    ...
    <div className="demo-kpis">{([['today', 'Hôm nay'], ['urgent', 'Gấp'], ['inProgress', 'Đang làm'], ['overdue', 'Quá hạn']] as const).map(([key, label]) => <article className="demo-kpi" key={key}><span>{label}</span><strong>{summary ? summary[key] : '…'}</strong></article>)}</div>
