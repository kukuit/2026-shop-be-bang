...
export default function Tasks() {
  ...
  const inputFor = (t: Task): TaskInput => ({ title: t.title, description: t.description, groupId: t.groupId, priority: t.priority, status: t.status, deadline: t.deadline, parentId: t.parentId, startTime: t.startTime ?? null, duration: t.duration ?? null, withinDay: t.withinDay ?? false, scheduleMode: t.scheduleMode, startNow: false })
