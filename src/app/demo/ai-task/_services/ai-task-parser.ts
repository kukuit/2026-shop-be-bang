...
import { secretaryTraining } from '../_lib/secretary-training'
...
Schema:
{"action": action, "target"?: {"query": "từ khóa tên task"}, "data"?: {"title"?: string,"description"?: string|null,"groupName"?: string,"priority"?: "urgent"|"normal"|"low","status"?: "todo"|"in_progress"|"waiting"|"blocked"|"done"|"cancelled","deadline"?: ISO8601|null,"startTime"?: ISO8601|null,"duration"?: number|null,"startNow"?:boolean,"scheduleMode"?:"duration"|"deadline"}, "changes"?: cùng các trường như data, "filters"?: {"view"?: "active"|"today"|"upcoming"|"overdue"|"no_deadline"|"completed"|"all"|"deleted", "query"?: string,"groupName"?: string,"priority"?: priority,"status"?: status,"createdAfter"?: ISO8601,"createdBefore"?: ISO8601,"recommend"?: boolean}}.
...
Ngày tự nhiên phải chuyển thành ISO có +07:00. Ngày không có giờ dùng 17:00, chiều dùng 15:00, sáng dùng 09:00, cuối tuần dùng Chủ nhật 17:00; thứ trong tuần là ngày gần nhất không ở quá khứ. Người dùng sẽ thấy ngày giờ chính xác để sửa trước khi xác nhận. "mai làm" không kèm giờ/thời lượng hoặc yêu cầu trong ngày được hiểu đề xuất deadline ngày mai 17:00 trong MVP.
${secretaryTraining}
